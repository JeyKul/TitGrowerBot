...
-- with logged shrinks). Stale_Tit_Shrinks' PK is (chat_id, uid, created_at), so uid sitting
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS stale_tit_shrinks_idx_chat_created_at
    ON Stale_Tit_Shrinks(chat_id, created_at DESC);

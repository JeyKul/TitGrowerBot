CREATE TABLE IF NOT EXISTS Titties_of_Day (
    chat_id bigint,
...
ALTER TABLE Tits ADD COLUMN IF NOT EXISTS bonus_attempts integer NOT NULL DEFAULT 0;
...
CREATE OR REPLACE TRIGGER trg_check_dod_timestamp BEFORE INSERT ON Titties_of_Day
...
AS $$
BEGIN
    RAISE EXCEPTION 'Updates of the Titties_of_Day table is forbidden!'
        USING ERRCODE = 'GD1E1';
END
$$;
